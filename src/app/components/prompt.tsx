...
export default function Prompt() {
    return (
     <section style={{backgroundImage: "url(bg-boost-desktop.svg"}} className="flex flex-col h-60 bg-purple-950 items-center bg-cover justify-center md:text-left text-center">

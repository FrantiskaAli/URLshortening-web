...
export default function Prompt({windowWidth}: Viewport) {
    ...
    return (
     <section style={{backgroundImage: "url('bg-boost-desktop.svg')", backgroundSize: 'cover', backgroundPosition:"center"}} className="flex flex-col h-60 bg-purple-950 items-center bg-cover justify-center md:text-left text-center">

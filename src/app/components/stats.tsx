export default function Stats() {
    return (
        < section className="self-center md:w-4/5 flex flex-col md:pt-12 relative pb-20 mt-8" >
            ...
            <article className="flex md:flex-row flex-col items-center justify-between basis-0 flex-grow-1 flex-shrink-1">
                
                <section className="w-80 h-60 z-10 relative rounded shadow-md">
                ...
                <section className="w-80 h-60 mt-16 z-10 relative rounded shadow-md" >
                ...
                <section className="w-80 h-60 mt-16 md:mt-32 z-10 relative rounded shadow-md">
